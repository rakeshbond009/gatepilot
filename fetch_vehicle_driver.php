...
try {
    ...
    // Fetch vehicle details with driver information    $vehicle_number = mysqli_real_escape_string($conn, $vehicle_number);
    $where_clause = "v.vehicle_number = '$vehicle_number'";    if ($has_is_active) {
