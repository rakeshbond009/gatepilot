    ...
    <div class="container">
        ...
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 16px; padding: 30px; margin-bottom: 25px; box-shadow: 0 8px 24px rgba(102, 126, 234, 0.25);">
            <div style="display: flex; align-items: center; gap: 15px;">
                ...
                <div>
                    <h1 style="margin: 0; color: white; font-size: 28px; font-weight: 700; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">
                        <?php echo $edit_data ? 'Edit Unloading Checklist' : 'Vehicle Unloading Checklist'; ?>
                    </h1>
                    <p style="margin: 5px 0 0 0; color: rgba(255,255,255,0.9); font-size: 14px;">Document ID: <?php echo $edit_data ? htmlspecialchars($edit_data['document_id']) : 'VCPL/STORE/FR/01'; ?> | Date: <?php echo $edit_data ? date('d.m.Y', strtotime($edit_data['document_date'])) : date('d.m.Y'); ?></p>
                </div>
            </div>
        </div>
        ...
        <form method="POST" action="" id="unloadingForm">
            ...
            <input type="hidden" name="inward_id" id="inward_id" value="<?php echo $edit_data ? $edit_data['inward_id'] : ''; ?>">
            ...
            <div class="card" style="margin-bottom: 20px; border-left: 4px solid #3b82f6; background: linear-gradient(to right, #eff6ff 0%, white 10%);">
                ...
                <div style="display: grid; grid-template-columns: 1fr; gap: 15px; margin-bottom: 15px;">
                    <div class="form-group">
                        ...
                        <input type="text" name="vehicle_registration_number" id="vehicle_registration_number" value="<?php echo $edit_data ? htmlspecialchars($edit_data['vehicle_registration_number']) : ''; ?>" required style="text-transform: uppercase; font-size: 16px; font-weight: 700; padding: 14px 18px; border: 2px solid #3b82f6; border-radius: 12px; transition: all 0.3s; width: 100%; box-shadow: 0 2px 4px rgba(59, 130, 246, 0.05);" onfocus="this.style.borderColor='#3b82f6'; this.style.boxShadow='0 0 0 4px rgba(59, 130, 246, 0.15)';" onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none'; fetchVehicleDetailsForUnloading();">
                        <small style="color: #6b7280; font-size: 12px; display: flex; align-items: center; gap: 5px; margin-top: 8px;">
                            <span>💡</span>
                            <span>Enter vehicle number and press Tab - details will auto-fill from master</span>
                        </small>
                        <div id="vehicle-inside-message" style="display:none; margin-top: 10px; padding: 12px 15px; border-radius: 10px; font-size: 13px; font-weight: 600; border-left: 4px solid;"></div>
                        <button type="button" id="btn-verify-items" class="btn" style="display: <?php echo ($edit_data && !empty($edit_data['inward_id'])) ? 'block' : 'none'; ?>; margin-top: 10px; width: 100%; background: #4f46e5; color: white; border-radius: 10px; font-weight: 600; padding: 12px; border: none; cursor: pointer; transition: all 0.3s; box-shadow: 0 4px 6px rgba(79, 70, 229, 0.2);">
                            🔍 Verify Inward Items
                        </button>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="vehicle_type" id="vehicle_type" value="<?php echo $edit_data ? htmlspecialchars($edit_data['vehicle_type']) : ''; ?>" required style="padding: 12px 16px; border: 2px solid #e5e7eb; border-radius: 10px; transition: all 0.3s;" onfocus="this.style.borderColor='#3b82f6'; this.style.boxShadow='0 0 0 3px rgba(59, 130, 246, 0.1)';" onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none';">
                    </div>
                </div>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    <div class="form-group">
...
?>
                                <option value="<?php echo $row['id']; ?>" <?php echo ($edit_data && $edit_data['transport_company_id'] == $row['id']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($row['transporter_name']); ?></option>
                            <?php
    endwhile;
endif; ?>
                        </select>
                        <input type="hidden" name="transport_company_name" id="transport_company_name" value="<?php echo $edit_data ? htmlspecialchars($edit_data['transport_company_name']) : ''; ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="card" style="margin-bottom: 20px; border-left: 4px solid #10b981; background: linear-gradient(to right, #f0fdf4 0%, white 10%);">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="permit_details" id="permit_details" value="<?php echo $edit_data ? htmlspecialchars($edit_data['permit_details']) : ''; ?>" placeholder="Details" style="padding: 12px 16px; border: 2px solid #e5e7eb; border-radius: 10px; transition: all 0.3s;" onfocus="this.style.borderColor='#10b981'; this.style.boxShadow='0 0 0 3px rgba(16, 185, 129, 0.1)';" onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none';">
                    </div>
                </div>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    <div class="form-group">
                        ...
                        <input type="text" name="insurance_details" id="insurance_details" value="<?php echo $edit_data ? htmlspecialchars($edit_data['insurance_details']) : ''; ?>" placeholder="Details" style="padding: 12px 16px; border: 2px solid #e5e7eb; border-radius: 10px; transition: all 0.3s;" onfocus="this.style.borderColor='#10b981'; this.style.boxShadow='0 0 0 3px rgba(16, 185, 129, 0.1)';" onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none';">
                    </div>
                    <div class="form-group">
                        <label style="font-weight: 600; color: #374151; display: flex; align-items: center; gap: 6px;">
                            <span>🌿</span>
                        ...
                        <input type="text" name="puc_certificate_details" id="puc_certificate_details" value="<?php echo $edit_data ? htmlspecialchars($edit_data['puc_certificate_details']) : ''; ?>" placeholder="Details" style="padding: 12px 16px; border: 2px solid #e5e7eb; border-radius: 10px; transition: all 0.3s;" onfocus="this.style.borderColor='#10b981'; this.style.boxShadow='0 0 0 3px rgba(16, 185, 129, 0.1)';" onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none';">
                    </div>
                </div>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    <div class="form-group">
                        ...
                        <input type="text" name="fitness_certificate_details" id="fitness_certificate_details" value="<?php echo $edit_data ? htmlspecialchars($edit_data['fitness_certificate_details']) : ''; ?>" placeholder="Details" style="padding: 12px 16px; border: 2px solid #e5e7eb; border-radius: 10px; transition: all 0.3s;" onfocus="this.style.borderColor='#10b981'; this.style.boxShadow='0 0 0 3px rgba(16, 185, 129, 0.1)';" onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none';">
                    </div>
                </div>
            </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div id="driver_selection_container">
                            <input type="text" name="driver_name" id="driver_name" value="<?php echo $edit_data ? htmlspecialchars($edit_data['driver_name']) : ''; ?>" placeholder="Driver Name">
                            <input type="text" name="driver_mobile" id="driver_mobile" value="<?php echo $edit_data ? htmlspecialchars($edit_data['driver_mobile']) : ''; ?>" placeholder="Mobile No." style="margin-top: 5px;">
                            <input type="hidden" name="selected_driver_id" id="selected_driver_id" value="<?php echo $edit_data ? ($edit_data['selected_driver_id'] ?? '') : ''; ?>">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="license_type" id="license_type" value="<?php echo $edit_data ? htmlspecialchars($edit_data['license_type']) : ''; ?>" placeholder="License Type">
                        <input type="date" name="license_valid_till" id="license_valid_till" value="<?php echo $edit_data ? $edit_data['license_valid_till'] : ''; ?>" style="margin-top: 5px;">
                    </div>
                </div>
            </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    <div class="form-group">
                        ...
                        <datalist id="vendor_list">
                            ...
                            ?>
                                    <option data-id="<?php echo $row['id']; ?>" data-gst="<?php echo $gst_value; ?>" value="<?php echo htmlspecialchars($row['vendor_name']); ?>"></option>
                            <?php
                                endwhile;
                            endif; ?>
                        </datalist>
                        <input type="hidden" name="vendor_id" id="vendor_id" value="<?php echo $edit_data ? htmlspecialchars($edit_data['vendor_id']) : ''; ?>">
                    </div>
                    <div class="form-group">
                        <label style="font-weight: 600; color: #374151; display: flex; align-items: center; gap: 6px;">
                            <span>📋</span>
                        ...
                        <input type="text" name="purchase_order_no" value="<?php echo $edit_data ? htmlspecialchars($edit_data['purchase_order_no']) : ''; ?>" style="padding: 12px 16px; border: 2px solid #e5e7eb; border-radius: 10px; transition: all 0.3s;" onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';" onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none';">
                    </div>
                </div>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    <div class="form-group">
                        ...
                        <input type="text" name="challan_no" value="<?php echo $edit_data ? htmlspecialchars($edit_data['challan_no']) : ''; ?>" style="padding: 12px 16px; border: 2px solid #e5e7eb; border-radius: 10px; transition: all 0.3s;" onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';" onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none';">
                    </div>
                    <div class="form-group">
                        <label style="font-weight: 600; color: #374151; display: flex; align-items: center; gap: 6px;">
                            <span>🧾</span>
                        ...
                        <input type="text" name="invoice_no" value="<?php echo $edit_data ? htmlspecialchars($edit_data['invoice_no']) : ''; ?>" style="padding: 12px 16px; border: 2px solid #e5e7eb; border-radius: 10px; transition: all 0.3s;" onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';" onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none';">
                    </div>
                </div>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    <div class="form-group">
                        ...
                        <input type="text" name="gst_number" id="gst_number" value="<?php echo $edit_data ? htmlspecialchars($edit_data['gst_number']) : ''; ?>" style="padding: 12px 16px; border: 2px solid #e5e7eb; border-radius: 10px; transition: all 0.3s;" onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';" onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none';">
                    </div>
                </div>
            </div>
...
?>
                    <div class="safety-item">
                        ...
                        <input type="text" name="safety_<?php echo $key; ?>_remarks" value="<?php echo htmlspecialchars($remarks); ?>" placeholder="Remarks (if NOT OK)" style="margin-top: 5px; width: 100%; padding: 8px; border: 1px solid #d1d5db; border-radius: 4px;">
                    </div>
                    <?php
endforeach; ?>
                </div>
            ...
            <div class="form-section">
                ...
                <div class="sub-item">
                    ...
                    <input type="text" name="tanker_sealing_status_remarks" value="<?php echo $edit_data ? htmlspecialchars($edit_data['tanker_sealing_status_remarks']) : ''; ?>" placeholder="Remarks (if NOT OK)" style="width: calc(100% - 220px);">
                </div>
                <div class="sub-item">
                    ...
                    <input type="text" name="tanker_emergency_panel_remarks" value="<?php echo $edit_data ? htmlspecialchars($edit_data['tanker_emergency_panel_remarks']) : ''; ?>" placeholder="Remarks (if NOT OK)" style="width: calc(100% - 220px);">
                </div>
                <div class="sub-item">
                    ...
                    <input type="text" name="tanker_fall_protection_remarks" value="<?php echo $edit_data ? htmlspecialchars($edit_data['tanker_fall_protection_remarks']) : ''; ?>" placeholder="Remarks (if NOT OK)" style="width: calc(100% - 220px);">
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="gross_weight_invoice" id="gross_weight_invoice" value="<?php echo $edit_data ? $edit_data['gross_weight_invoice'] : ''; ?>" step="0.01" placeholder="In kg" oninput="calculateNetWeightAudit()">
                    </div>
                    <div class="form-group">
                        <label>Tare Weight At The Time Of Entry</label>
                        <input type="number" name="tare_weight_invoice" id="tare_weight_invoice" value="<?php echo $edit_data ? $edit_data['tare_weight_invoice'] : ''; ?>" step="0.01" placeholder="In kg" oninput="calculateNetWeightAudit()">
                    </div>
                    <div class="form-group">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    <label>Remarks</label>
                    <textarea name="other_remarks"><?php echo $edit_data ? htmlspecialchars($edit_data['other_remarks']) : ''; ?></textarea>
                </div>
            
            <!-- Items Verification Modal -->
            <div id="itemsModal" class="modal" style="display:none; position: fixed; z-index: 2000; left: 0; top: 0; width: 100%; height: 100%; overflow: auto; background-color: rgba(0,0,0,0.5); backdrop-filter: blur(4px);">
                <div class="modal-content" style="background-color: #fefefe; margin: 10% auto; padding: 0; border: none; width: 90%; max-width: 600px; border-radius: 16px; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04); overflow: hidden; animation: modalSlideIn 0.3s ease-out;">
                    <div style="background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); padding: 20px; color: white; display: flex; justify-content: space-between; align-items: center;">
                        <h2 style="margin: 0; font-size: 20px; font-weight: 700;">
                            📦 Verify Items <span id="modal-item-count" style="background: rgba(255,255,255,0.2); font-size: 14px; padding: 2px 10px; border-radius: 20px; margin-left: 10px; border: 1px solid rgba(255,255,255,0.3);">0</span>
                        </h2>
                        <span class="close-modal" style="color: white; font-size: 28px; font-weight: bold; cursor: pointer; transition: 0.3s;" onclick="document.getElementById('itemsModal').style.display='none'">&times;</span>
                    </div>
                    <div style="padding: 20px;">
                        <p style="color: #6b7280; font-size: 14px; margin-bottom: 15px;">Please verify and tick the items recorded during the inward process.</p>
                        
                        <!-- Search & Select All -->
                        <div style="margin-bottom: 15px; display: flex; gap: 10px; align-items: center;">
                            <div style="position: relative; flex: 1;">
                                <span style="position: absolute; left: 12px; top: 10px; color: #94a3b8;">🔍</span>
                                <input type="text" id="modal-item-search" placeholder="Search items..." style="width: 100%; padding: 10px 10px 10px 35px; border: 1px solid #e2e8f0; border-radius: 10px; font-size: 14px; transition: all 0.3s;" onkeyup="filterModalItems()">
                            </div>
                            <label style="display: flex; align-items: center; gap: 8px; font-size: 13px; color: #4b5563; background: #f3f4f6; padding: 8px 12px; border-radius: 10px; cursor: pointer; border: 1px solid #e5e7eb;">
                                <input type="checkbox" id="modal-select-all" onclick="toggleAllModalItems(this)" style="width: 18px; height: 18px; accent-color: #4f46e5;">
                                <span>Verify All</span>
                            </label>
                        </div>

                        <div id="modal-items-list" style="max-height: 400px; overflow-y: auto; padding-right: 5px;">
                        ...
                        <div style="margin-top: 25px; display: flex; gap: 10px;">
                            <button type="button" class="btn btn-primary" style="flex: 1;" onclick="document.getElementById('itemsModal').style.display='none'">Confirm Verification</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style="text-align: center; margin-top: 30px;">
                ...
                if ($show_submit): ?>
                    <button type="submit" name="submit_unloading" id="submitUnloadingBtn" class="btn btn-primary" style="padding: 12px 30px; font-weight: 700; border-radius: 12px; border: none; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; cursor: pointer; transition: all 0.3s; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.2);">
                        <?php echo $edit_data ? 'Update Checklist' : 'Save Checklist'; ?>
                    </button>
                <?php else: ?>
                    <div style="background: #fee2e2; color: #ef4444; padding: 12px 20px; border-radius: 10px; font-weight: 600; border: 1px solid #fecaca;">
                ...
                <button type="button" onclick="window.history.back();" class="btn btn-secondary" style="margin-left: 10px;">Back / Cancel</button>
            </div>
        </form>
