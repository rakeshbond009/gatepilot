<?php if ($page == 'login'):
    ...
    <div class="landing-page">
        ...
        <header class="landing-header">
            ...
            <div class="header-actions" style="display: flex; align-items: center; gap: 40px;">
                <a href="https://www.codepilotx.com/pages/contact.html" target="_blank"
                    style="color: #64748b; text-decoration: none; font-weight: 800; font-size: 1.1rem; transition: color 0.3s; padding: 10px 0;"
                    onmouseover="this.style.color='#4f46e5'" onmouseout="this.style.color='#64748b'">Contact Us</a>
