            ...
            <div id="tenantsSection">
                <div class="master-card"
                    ...
                    if (isset($_SESSION['admin_msg'])):
                        ...
                        ?>
                        <div
                            style="background: <?php echo $bgColor; ?>; color: white; padding: 15px 25px; border-radius: 12px; margin-bottom: 25px; font-weight: 600; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1); display: flex; align-items: center; gap: 12px; animation: slideDown 0.4s ease-out;">
                            <span style="font-size: 20px;"><?php echo $icon; ?></span>
                            <div>
                                <strong
                                    style="display:block; font-size: 14px;"><?php echo htmlspecialchars($msg['title']); ?></strong>
                                <span
                                    style="font-weight: 400; font-size: 13px; opacity: 0.9;"><?php echo htmlspecialchars($msg['msg']); ?></span>
                            </div>
                        </div>
                        <style>
                            @keyframes slideDown {
                    ...
                    <div
                        style="margin-bottom: 25px; display: flex; justify-content: space-between; align-items: center; background: #f8fafc; padding: 20px; border-radius: 12px; border: 1px solid #e2e8f0;">
                        <div>
                        ...
                        <div style="text-align: right;">
                            <span
                                style="color: #64748b; font-size: 11px; display: block; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">System
                                Authority</span>
                    ...
                    <div id="hostingerCheckModal" class="perm-modal-overlay"
                        style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(15, 23, 42, 0.9); backdrop-filter: blur(8px); z-index: 10001; align-items: center; justify-content: center;">
                        <div class="perm-modal-content"
                            style="width: 90%; max-width: 450px; background: white; border-radius: 24px; overflow: hidden; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.5); text-align: center; border: 1px solid rgba(255,255,255,0.1); animation: modalPop 0.3s cubic-bezier(0.34, 1.56, 0.64, 1);">
                            <div style="padding: 40px 30px; background: #ef4444; color: white;">
                                ...
                                <h3 style="margin: 0; font-size: 24px; font-weight: 900; letter-spacing: -0.5px;">MANDATORY STEP
                                </h3>
                                <p
                                    style="margin: 10px 0 0 0; opacity: 0.8; font-size: 13px; text-transform: uppercase; font-weight: 700;">
                                    Hostinger & Shared Hosting Only</p>
                            </div>
                            <div style="padding: 40px 35px;">
                                <h4
                                    style="margin: 0 0 15px 0; color: #1e293b; font-size: 19px; font-weight: 800; line-height: 1.3;">
                                    Is your Hostinger Database Created?</h4>
                                <p style="color: #64748b; font-size: 14px; line-height: 1.6; margin-bottom: 30px;">
                                    For production environments like <strong>Hostinger hPanel</strong>, you MUST manually create
                                    the <strong>Database, User, and Password</strong> first.<br><br>
                                    Do you have your MySQL credentials ready?
                                </p>
                                <div style="display: flex; gap: 12px;">
                                    <button type="button" onclick="closeHostingerCheck()"
                                        style="flex: 1; padding: 14px; border: 1px solid #e2e8f0; border-radius: 12px; background: #f8fafc; color: #64748b; font-weight: 600; cursor: pointer; transition: all 0.2s;">No,
                                        not yet</button>
                                    <button type="button" onclick="confirmHostingerReady()"
                                        style="flex: 1.5; padding: 14px; border: none; border-radius: 12px; background: #ef4444; color: white; font-weight: 700; cursor: pointer; box-shadow: 0 8px 16px rgba(239, 68, 68, 0.3); transition: all 0.2s;">Yes,
                                        DB is Ready! 🚀</button>
                                </div>
                            </div>
                        </div>
                                ...
                                <form id="provisionForm" method="POST">
                                            ...
                                            <div id="credentialsWrapper"
                                                ...
                                                <div>
                                                    ...
                                                    <div style="display: flex; gap: 5px;">
                                                        ...
                                                        <button type="button"
                                                            onclick="document.getElementById('tenantAdminPass').value = generateRandomPass(12)"
                                                            style="background: #f1f5f9; border: 1px solid #e2e8f0; border-radius: 8px; padding: 0 12px; cursor: pointer;"
                                    ...
                                    <div
                                        ...
                                        <label
                                            ...
                                            Address</label>
                                        <textarea name="address" id="t_address" rows="2" placeholder="Full company address..."
                    ...
                    <div class="card"
                        ...
                        <div class="master-form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="maker" id="veh_maker" placeholder="e.g., TATA, Ashok Leyland" required
                                    style="padding: 12px 16px; border: 2px solid #e5e7eb; border-radius: 10px; transition: all 0.3s;"
                                    onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';"
                                    onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none';">
                            </div>
                        ...
                        <div class="master-form-grid">
                            ...
                            <div style="border: 1px solid #e5e7eb; padding: 15px; border-radius: 8px; background: white;">
                                ...
                                <div
                                    ...
                                    <input type="file" name="fitness_photo_camera" id="fitness_photo_camera" accept="image/*"
                                        capture="environment">
                                </div>
                                <div style="display: flex; gap: 5px;">
                        ...
                        <form method="POST" enctype="multipart/form-data" onsubmit="showAppLoader('Saving Employee Data...')">
                            ...
                            <div class="master-form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="mobile" id="master_emp_mobile" pattern="[0-9]{10}" minlength="10"
                                        maxlength="10" title="Please enter exactly 10 digits" required
                                        style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 8px;">
                                </div>
                                <div class="form-group">
                ...
                <div
                    ...
                    <div style="display: flex; gap: 10px;">
                        <button onclick="window.print()" class="btn btn-primary" style="flex: 1;">🖨️
                            Print</button>
                        <button onclick="document.getElementById('empQRModal').style.display='none'" class="btn btn-secondary"
            ...
            ?>
                        <div
                            ...
                            <div
                                ...
                                <button onclick="document.getElementById('auditFilterModal').style.display='flex'" class="btn"
            ...
            <div style="padding: 30px; background: white;">
                <div
                    ...
                    <div style="flex: 1;"><label
                        ...
                        <div id="auditUser" style="font-weight: 700; color: #1e293b; font-size: 17px; margin-top: 4px;">
                        </div>
                    </div>
                    <div style="flex: 1;"><label
            ...
            <form method="POST" style="padding: 24px;">
                ...
                <div style="margin-bottom: 30px;">
                    ...
                    <div class="perm-grid">
                        ...
                        <label class="perm-card"><input type="checkbox" name="perm_page_management" id="p_management">
                        ...
                        <label class="perm-card"><input type="checkbox" name="perm_page_audit_logs" id="p_audit_logs">
                        ...
                        <label class="perm-card"><input type="checkbox" name="perm_page_app_issues" id="p_app_issues">
                ...
                <div style="margin-bottom: 30px;">
                    ...
                    <div class="perm-grid">
                        ...
                        <label class="perm-card"><input type="checkbox" name="perm_master_employees" id="m_employees">
                        ...
                        <label class="perm-card"><input type="checkbox" name="perm_page_permissions" id="p_permissions">
                ...
                <div style="background: #f9fafb; border-radius: 12px; padding: 16px; border: 1px solid #e5e7eb;">
                    ...
                    <?php if (isset($_SESSION['super_admin']) && $_SESSION['super_admin'] == 1): ?>
                        <div class="action-row">
                            ...
                            </div><label class="switch"><input type="checkbox" name="perm_action_delete" id="a_delete"><span
                                    class="slider"></span></label>
                        </div>
                        <?php
                    endif; ?>
