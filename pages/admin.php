...
function openPermissionModal(user) {
    ...
    if (perms.pages) {
        ...
        if (p.user_permissions || p.permissions) document.getElementById("p_permissions").checked = true;
            ...
            <div class="container">
                ...
                <div class="card">
                    ...
                    <div class="actions-grid" style="grid-template-columns: repeat(auto-fit, minmax(150px, 1fr));">
                        ...
                        <?php if (hasPermission('pages.user_permissions')): ?>
                            ...
                            <form method="POST" enctype="multipart/form-data" style="margin-top: 20px;">
                                <div style="margin-bottom: 15px;">
                                    <label style="display: block; margin-bottom: 8px; font-weight: 600;">Upload Company
                                        Logo:</label>
                                    <input type="file" name="company_logo" accept="image/jpeg,image/jpg,image/png,image/gif"
                                        required
...
?>
                    ...
                    <div class="card" style="margin-bottom: 20px;">
                        ...
                        <div id="userForm" class="perm-modal-overlay">
                            <div class="perm-modal-content" style="max-width: 800px; padding: 0; border-radius: 16px; overflow: hidden;">
                                <div style="padding: 24px 30px; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); color: white; display: flex; justify-content: space-between; align-items: center;">
                                    <div>
                                        <h3 id="userFormTitle" style="margin:0; font-size: 20px; font-weight: 700;">👤 User Profile Manager</h3>
                                        <p style="margin: 4px 0 0 0; font-size: 13px; color: rgba(255,255,255,0.8);">Create or update system user accounts</p>
                                    </div>
                                    <button type="button" onclick="document.getElementById('userForm').style.display='none'" style="background: rgba(255,255,255,0.2); border: none; width: 32px; height: 32px; border-radius: 50%; color: white; font-size: 20px; cursor: pointer; display: flex; align-items: center; justify-content: center;">&times;</button>
                                </div>
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                                        ...
                                        <div style="background: #f8fafc; padding: 20px; border-radius: 12px; border: 1px solid #e2e8f0;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="user_photo" id="user_photo" accept="image/*" style="width: 100%; padding: 8px; border: 1.5px solid #d1d5db; border-radius: 8px; background: white;">
                                                <small style="color: #64748b; font-size: 11px; margin-top: 4px; display: block;">JPG or PNG, max 2MB</small>
                                            </div>
                                        </div>
                                    </div>

                                    <div style="display: flex; gap: 12px; margin-top: 30px; padding-top: 20px; border-top: 1px solid #f1f5f9; justify-content: flex-end;">
                                        <button type="button" onclick="document.getElementById('userForm').style.display='none'" class="btn btn-secondary" style="padding: 12px 25px; border-radius: 10px; font-weight: 600; min-width: 120px;">Cancel</button>
                                        <button type="submit" name="save_user" class="btn btn-primary" style="padding: 12px 30px; border-radius: 10px; font-weight: 600; background: #3b82f6; border: none; min-width: 150px; box-shadow: 0 4px 6px -1px rgba(59, 130, 246, 0.2);">💾 Save Profile</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
?>
                                                        <button
                                                            ...
                                                            Edit</button>
                                                        <?php if (hasPermission('pages.user_permissions')): ?>
                                                            <button class="btn btn-sm" style="background: #4f46e5; color: white; padding: 5px 10px; font-size: 12px; margin-right: 5px;"
                            ...
                            <div class="card"
                                ...
                                <div class="form-group" style="margin-top: 15px;">
                                    ...
                                    <div
                                        ...
                                        <input type="file" name="license_photo_camera" id="license_photo_camera"
                    ...
                    <div class="card" style="margin-bottom: 20px;">
                        ...
                        <div id="vehicleForm" style="display: none; margin-bottom: 20px;">
                            <form method="POST" enctype="multipart/form-data"
                                onsubmit="showAppLoader('Saving Vehicle Data...')">
                                ...
                                <div class="card"
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="maker" id="veh_maker"
                                ...
                                <div class="card"
                                    ...
                                    <div class="form-group">
                                        <label
                                            style="font-weight: 600; color: #374151; margin-bottom: 10px; display: block;">Select
                                            Drivers</label>
        ...
        endforeach; ?>
                                ...
                                <div class="card"
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                                        ...
                                        <!-- RC Photo -->
                                        <div
                                            style="border: 1px solid #e5e7eb; padding: 15px; border-radius: 8px; background: white;">
                                        ...
                                        <div
                                            ...
                                            <div
                                                style="opacity: 0.1; position: absolute; z-index: -1; width: 1px; height: 1px; overflow: hidden;">
                                                <input type="file" name="insurance_photo" id="insurance_photo_file"
                                                    accept="image/*">
                                        ...
                                        <div
                                            ...
                                            <div
                                                style="opacity: 0.1; position: absolute; z-index: -1; width: 1px; height: 1px; overflow: hidden;">
                                                <input type="file" name="pollution_photo" id="pollution_photo_file"
                                                    accept="image/*">
                                        ...
                                        <div
                                            ...
                                            <div
                                                style="opacity: 0.1; position: absolute; z-index: -1; width: 1px; height: 1px; overflow: hidden;">
                                                <input type="file" name="fitness_photo" id="fitness_photo_file"
                                                    accept="image/*">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <input type="file" name="permit_photo_camera" id="permit_photo_camera"
                                                    accept="image/*" capture="environment">
                                            </div>
                                            <div style="display: flex; gap: 5px;">
                    ...
                    <div class="card" style="margin-bottom: 20px;">
                        <div
                            ...
                            <div style="display: flex; gap: 10px;">
                                ...
                                <a href="?page=print-employee-qrs" target="_blank" class="btn btn-secondary" style="padding: 12px 24px; background: #6366f1; color: white; text-decoration: none; border-radius: 8px; display: flex; align-items: center; gap: 8px;">
                                    🖨️ Bulk Print QRs
                                </a>
                            </div>
        ...
        if (isset($_POST['save_patrol_location'])) {
            ...
            try {
                if ($_POST['p_id']) {
                    ...
                    $changes = [];
                    if ($current) {
                        if ($current['location_id'] !== $loc_id) $changes[] = "LocID: [{$current['location_id']} ➔ $loc_id]";
                        if ($current['location_name'] !== $name) $changes[] = "Name: [{$current['location_name']} ➔ $name]";
                        if ($current['area_site_building'] !== $area) $changes[] = "Area: [{$current['area_site_building']} ➔ $area]";
                    }
                            ...
                            <form method="POST">
                                ...
                                <div style="display: flex; gap: 10px;">
                                    <button type="submit" name="save_patrol_location" class="btn btn-success">💾 Save
                                        Location</button>
                                    <button type="button" onclick="closePatrolLocForm()"
        ...
        if (isset($_POST['save_material'])) {
            ...
            try {
                if ($_POST['material_id']) {
                    ...
                    $changes = [];
                    if ($current) {
                        if ($current['material_description'] !== $desc) $changes[] = "Desc: [{$current['material_description']} ➔ $desc]";
                        if ($current['material_category'] !== $cat) $changes[] = "Cat: [{$current['material_category']} ➔ $cat]";
                    }
        ...
        if (isset($_POST['save_supplier'])) {
            ...
            try {
                if ($_POST['supplier_id']) {
                    ...
                    $changes = [];
                    if ($current) {
                        if ($current['supplier'] !== $supp) $changes[] = "Name: [{$current['supplier']} ➔ $supp]";
                        if ($current['supp_code'] !== $supp_code) $changes[] = "Code: [{$current['supp_code']} ➔ $supp_code]";
                    }
...
?>
                        <div style="background: linear-gradient(135deg, #1e293b 0%, #334155 100%); border-radius: 16px; padding: 25px; margin-bottom: 25px; box-shadow: 0 8px 24px rgba(0,0,0,0.15);">
                            <div style="display: flex; align-items: center; justify-content: space-between; gap: 15px; flex-wrap: wrap;">
                                <div style="display: flex; align-items: center; gap: 15px;">
                                    <div style="font-size: 40px; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.2));">📜</div>
                                    <div>
                                        <h2 style="margin: 0; color: white; font-size: 24px; font-weight: 700; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">System Audit Logs</h2>
                                        <p style=
                                        "margin: 5px 0 0 0; color: rgba(255,255,255,0.7); font-size: 13px;">Overview of all past activities and administrative changes</p>
                                    </div>
                                </div>
                                <button onclick="document.getElementById('auditFilterModal').style.display='flex'" class="btn" style="background: #4b5563; color: white; border: none; padding: 10px 20px; border-radius: 10px; font-weight: 600; display: flex; align-items: center; gap: 8px;">
                                    🔍 Search & Filter
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="card" style="margin-bottom: 20px;">
                            <div class="table-wrapper" id="auditLogsTable">
                                <table style="width: 100%; border-collapse: collapse;">
                                    <thead style="background: #f1f5f9;">
                                        <tr style="text-align: left;">
                                            <th style="padding: 12px; border-bottom: 2px solid #e2e8f0; font-size: 12px; font-weight: 600; color: #475569;">TIME</th>
                                            <th style="padding: 12px; border-bottom: 2px solid #e2e8f0; font-size: 12px; font-weight: 600; color: #475569;">USER</th>
                                            <th style="padding: 12px; border-bottom: 2px solid #e2e8f0; font-size: 12px; font-weight: 600; color: #475569;">ACTIVITY</th>
                                            <th style="padding: 12px; border-bottom: 2px solid #e2e8f0; font-size: 12px; font-weight: 600; color: #475569;">PAGE NAME</th>
                                            <th style="padding: 12px; border-bottom: 2px solid #e2e8f0; font-size: 12px; font-weight: 600; color: #475569;">IP ADDRESS</th>
                                            <th style="padding: 12px; border-bottom: 2px solid #e2e8f0; font-size: 12px; font-weight: 600; color: #475569;">DETAILS</th>
                                        </tr>
                                    </thead>
                                    <tbody>
            ...
            if (stripos($log['activity_type'], 'CREATED') !== false)
                $badge_class = 'badge-success';
?>
                                                    <span class="badge <?php echo $badge_class; ?>" style="font-size: 10px;"><?php echo htmlspecialchars($log['activity_type']); ?></span>
                                                </td>
                                                <td style="padding: 12px; font-size: 13px; color: #4b5563;">
                                                    <?php echo htmlspecialchars($log['module']); ?>
                                                </td>
                                                <td style="padding: 12px; font-size: 12px; color: #94a3b8; font-family: monospace;">
...
?>
        ...
        endwhile; ?>
                                        <?php if (mysqli_num_rows($audit_logs) == 0): ?>
                                            <tr>
                                                <td colspan="6" style="padding: 40px; text-align: center; color: #94a3b8;">No audit records found yet</td>
                                            </tr>
                                        <?php
        endif; ?>
                                    </tbody>
...
<div id="auditDetailModal" class="perm-modal-overlay">
    <div class="perm-modal-content" style="max-width: 650px; border-radius: 20px; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5); overflow: hidden; border: none;">
        <div style="padding: 24px 30px; background: linear-gradient(135deg, #6366f1 0%, #4f46e5 100%); color: white; display: flex; justify-content: space-between; align-items: center;">
            <div><h2 style="margin: 0; font-size: 20px; font-weight: 700;">📜 Activity Details</h2><p id="auditTime" style="margin: 4px 0 0 0; font-size: 13px; color: rgba(255,255,255,0.8);"></p></div>
            <button onclick="document.getElementById('auditDetailModal').style.display='none'" style="background: rgba(255,255,255,0.2); border: none; width: 32px; height: 32px; border-radius: 50%; color: white; font-size: 20px; cursor: pointer; display: flex; align-items: center; justify-content: center;">&times;</button>
        </div>
        <div style="padding: 30px; background: white;">
            <div style="display: flex; gap: 30px; margin-bottom: 25px; background: #f8fafc; padding: 20px; border-radius: 12px; border: 1px solid #f1f5f9;">
                <div style="flex: 1;"><label style="display: block; font-size: 11px; font-weight: 700; color: #94a3b8; text-transform: uppercase;">User</label><div id="auditUser" style="font-weight: 700; color: #1e293b; font-size: 17px; margin-top: 4px;"></div></div>
                <div style="flex: 1;"><label style="display: block; font-size: 11px; font-weight: 700; color: #94a3b8; text-transform: uppercase;">Activity</label><div id="auditTypeBadge" style="display: inline-block; margin-top: 5px; padding: 4px 12px; border-radius: 8px; font-size: 12px; font-weight: 700;"></div></div>
            </div>
            <label style="display: block; font-size: 11px; font-weight: 700; color: #64748b; text-transform: uppercase; margin-bottom: 12px;">Update Summary / Details</label>
            <div id="auditDetailsContainer" style="background: #ffffff; border: 1.5px solid #eef2ff; border-radius: 12px; padding: 20px; margin-bottom: 20px; min-height: 100px; max-height: 350px; overflow-y: auto; box-shadow: inset 0 2px 4px rgba(0,0,0,0.02);">
                <div id="auditDetails" style="font-size: 14px; line-height: 1.6; color: #334155;"></div>
            </div>
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; font-size: 13px; color: #64748b; border-top: 1px solid #f1f5f9; padding-top: 20px;">
                <div><strong>Page Name:</strong> <span id="auditModule" style="color: #475569;"></span></div>
                <div style="text-align: right;"><strong>IP ADDRESS:</strong> <span id="auditIP" style="color: #475569; font-family: monospace;"></span></div>
            </div>
        </div>
        <div style="padding: 20px 30px; background: #f8fafc; border-top: 1px solid #f1f5f9; text-align: right;">
            <button onclick="document.getElementById('auditDetailModal').style.display='none'" class="btn btn-secondary" style="background: #475569; border: none; padding: 10px 25px; border-radius: 10px; font-weight: 600;">Close View</button>
        </div>
    </div>
</div>
...
<div id="permModal" class="perm-modal-overlay">
    <div class="perm-modal-content">
        <div style="padding: 24px; border-bottom: 1px solid #f3f4f6; display: flex; justify-content: space-between; align-items: center; background: #ffffff;">
            <div>
                <h2 style="margin: 0; font-size: 22px; font-weight: 700; color: #111827;">Access Control</h2>
                <p style="margin: 4px 0 0 0; font-size: 14px; color: #6b7280;">Manage permissions for <strong id="permUser" style="color: #4f46e5;"></strong></p>
            </div>
            <button onclick="document.getElementById('permModal').style.display='none'" style="background: #f3f4f6; border: none; width: 32px; height: 32px; border-radius: 50%; color: #4b5563; font-size: 20px; cursor: pointer; display: flex; align-items: center; justify-content: center;">&times;</button>
        </div>
        ...
        <form method="POST" style="padding: 24px;">
            ...
            <div style="margin-bottom: 30px;">
                ...
                <div class="perm-grid">
                    <label class="perm-card"><input type="checkbox" name="perm_page_dashboard" id="p_dashboard"><div class="perm-card-content">Dashboard</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_page_inward" id="p_inward"><div class="perm-card-content">Inward Entry</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_page_outward" id="p_outward"><div class="perm-card-content">Outward Exit</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_page_inside" id="p_inside"><div class="perm-card-content">Trucks Inside</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_page_history" id="p_history"><div class="perm-card-content">Vehicle History</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_page_patrol" id="p_patrol"><div class="perm-card-content">Guard Patrol</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_page_reports" id="p_reports"><div class="perm-card-content">Reports</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_page_register" id="p_register"><div class="perm-card-content">Manual Registers</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_page_register_types" id="p_register_types"><div class="perm-card-content">Manage Register Types</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_page_loading" id="p_loading"><div class="perm-card-content">Loading Checklist</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_page_unloading" id="p_unloading"><div class="perm-card-content">Unloading Checklist</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_page_management" id="p_management"><div class="perm-card-content">Management Dash</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_page_tickets" id="p_tickets"><div class="perm-card-content">Tickets</div></label>
            ...
            <div style="margin-bottom: 30px;">
                ...
                <div class="perm-grid">
                    <label class="perm-card"><input type="checkbox" name="perm_master_transporters" id="m_transporters"><div class="perm-card-content">Transporters</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_master_drivers" id="m_drivers"><div class="perm-card-content">Drivers</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_master_vehicles" id="m_vehicles"><div class="perm-card-content">Vehicles</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_master_purposes" id="m_purposes"><div class="perm-card-content">Purposes</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_master_employees" id="m_employees"><div class="perm-card-content">Employees</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_master_departments" id="m_departments"><div class="perm-card-content">Departments</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_master_patrol" id="m_patrol"><div class="perm-card-content">Patrol QR</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_master_materials" id="m_materials"><div class="perm-card-content">Materials</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_master_suppliers" id="m_suppliers"><div class="perm-card-content">Suppliers</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_master_users" id="m_users"><div class="perm-card-content">Users</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_master_settings" id="m_settings"><div class="perm-card-content">Settings</div></label>
                    <label class="perm-card"><input type="checkbox" name="perm_page_permissions" id="p_permissions"><div class="perm-card-content">User Permissions</div></label>
                </div>
            </div>

            <div style="background: #f9fafb; border-radius: 12px; padding: 16px; border: 1px solid #e5e7eb;">
                <div class="perm-section-title" style="margin-bottom: 10px;"><span>⚡</span> Operational Actions</div>
                <div class="action-row"><div class="action-info"><h4>View Action Buttons</h4><p>Show/Hide Edit & Delete buttons</p></div><label class="switch"><input type="checkbox" name="perm_action_buttons" id="a_buttons"><span class="slider"></span></label></div>
                <div class="action-row"><div class="action-info"><h4>Edit Records</h4><p>Allow entry modifications</p></div><label class="switch"><input type="checkbox" name="perm_action_edit" id="a_edit"><span class="slider"></span></label></div>
                <?php if (isset($_SESSION['super_admin']) && $_SESSION['super_admin'] == 1): ?>
                <div class="action-row"><div class="action-info"><h4>Delete Records</h4><p style="color:#ef4444;">Permanent removal</p></div><label class="switch"><input type="checkbox" name="perm_action_delete" id="a_delete"><span class="slider"></span></label></div>
                <?php
endif; ?>
            </div>

            <div style="display: flex; gap: 12px; margin-top: 30px; padding-top: 20px; border-top: 1px solid #f3f4f6;">
                <button type="button" onclick="document.getElementById('permModal').style.display='none'" class="btn btn-secondary" style="flex: 1; padding: 12px; font-weight: 600;">Cancel</button>
                <button type="submit" name="save_permissions" class="btn btn-primary" style="flex: 2; padding: 12px; font-weight: 600; background: linear-gradient(135deg, #4f46e5 0%, #4338ca 100%); border: none;">Save Changes</button>
            </div>
        </form>
    </div>
</div>
...
<div id="auditFilterModal" class="perm-modal-overlay">
    <div class="perm-modal-content" style="max-width: 500px;">
        <div style="padding: 20px 25px; background: #1e293b; color: white; display: flex; justify-content: space-between; align-items: center;">
            <h3 style="margin:0;">🔍 Filter Logs</h3>
            <button type="button" onclick="document.getElementById('auditFilterModal').style.display='none'" style="background: transparent; border: none; color: white; font-size: 24px; cursor: pointer;">&times;</button>
        </div>
        <form method="GET" style="padding: 25px;">
            ...
            <div class="form-group" style="margin-bottom: 15px;">
                ...
                <select name="f_module" style="width: 100%; padding: 10px; border: 1.5px solid #d1d5db; border-radius: 8px; background: white;">
...
?>
            ...
            <div class="form-group" style="margin-bottom: 15px;">
                ...
                <select name="f_type" style="width: 100%; padding: 10px; border: 1.5px solid #d1d5db; border-radius: 8px; background: white;">
...
?>
            ...
            <div style="display: flex; gap: 10px; margin-top: 25px;">
                <button type="submit" class="btn btn-primary" style="flex: 2; padding: 12px; background: #4f46e5; border: none;">Apply Filters</button>
                <a href="?page=admin&master=audit_logs" class="btn btn-secondary" style="flex: 1; padding: 12px; text-align: center; text-decoration: none;">Reset</a>
            </div>
        </form>
    </div>
</div>
